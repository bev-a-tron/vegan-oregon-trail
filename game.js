...
function preload() {
    ...
    game.load.atlasXML('seacreatures', 'phaser-examples/examples/assets/sprites/seacreatures.png', 'phaser-examples/examples/assets/sprites/seacreatures.xml');
    ...
    game.load.image('undersea', 'phaser-examples/examples/assets/pics/undersea.jpg');
    game.load.image('coral', 'phaser-examples/examples/assets/pics/seabed.png');
